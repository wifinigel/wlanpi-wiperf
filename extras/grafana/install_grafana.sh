...
sudo sed -i 's/^;default_home_dashboard_path =.*$/default_home_dashboard_path = /usr/share/grafana/public/dashboards/01-Probe Summary.json/' /etc/grafana/grafana.ini
